...
regex = re.compile(
    r"({gateState === 'COMPARING' && scannedResult && \(\s+/\* Stage 2: Dual image split comparison and countdown \*/.*?)(                  {/\* Unified Decision Actions Block \*/})",
    re.DOTALL
)

replacement = """{gateState === 'COMPARING' && scannedResult && (
